...
│   ├── +profiles/     # Profile definitions and options
...
└── sys/    # System-level configuration
    ├── base/          # Base system aspects (i18n, keyboard, shell, etc.)
    ├── bundle/        # Aspect bundles (cli, graphical, dev, essential)
    ├── de/            # Desktop environment aspects
    ├── dm/            # Display manager configuration
